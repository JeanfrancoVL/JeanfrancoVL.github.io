...
(function initCanvas() {
  ...
  const orbs = [
    { bx:.12, by:.22, rx:.10, ry:.08, r:.56, c:[78,32,205],  a:.60 },
    { bx:.80, by:.60, rx:.08, ry:.10, r:.50, c:[196,162,101], a:.36 },
    { bx:.42, by:.52, rx:.09, ry:.09, r:.48, c:[58,20,175],  a:.52 },
    { bx:.54, by:.04, rx:.07, ry:.06, r:.40, c:[52,16,135],  a:.45 },
    { bx:.04, by:.82, rx:.09, ry:.07, r:.36, c:[196,162,101], a:.18 },
  ];
